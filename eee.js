document.addEventListener("DOMContentLoaded", () => {
    ...
    const firstYearTheoryList = document.getElementById('eee-first-year-theory-list');
    const secondYearTheoryList = document.getElementById('eee-second-year-theory-list');
    const thirdYearTheoryList = document.getElementById('eee-third-year-theory-list');
    
    const firstYearLabList = document.getElementById('eee-first-year-lab-list');
    const secondYearLabList = document.getElementById('eee-second-year-lab-list');
    const thirdYearLabList = document.getElementById('eee-third-year-lab-list');
